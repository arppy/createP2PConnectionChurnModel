      ...
      if int(trace[user][lineI][1]) == 1 :
        ...
        for neighborInt in range(0,100000):
          ...
          for lineNeighborI in range(neighborIndex[neighbor],len(trace[neighbor])-1) :
            ...
            if (traceAssignment[user] == "es6rqhwLUdDJZadBiipTwq9CAEL2AR8b-Zx8jBht5DA296"):
              ...
              if (sessionStartUser <= sessionStartNeighbor < sessionEndUser <= sessionEndNeighbor) or \
                ...
                print("OK", coreNumber, traceAssignment[user], lineI, sessionStartUser, sessionEndUser,
                      ...
                      str(featureVector), "1",
                      str((sessionStartUser <= sessionStartNeighbor < sessionEndUser <= sessionEndNeighbor)),
                ...
                print("NO", coreNumber, traceAssignment[user], lineI, sessionStartUser, sessionEndUser,
                      str(trace[user][lineI]), str(trace[user][lineI + 1]),
                      traceAssignment[neighbor], lineNeighborI, sessionStartNeighbor, sessionEndNeighbor,
                      str(trace[neighbor][lineNeighborI]), str(trace[neighbor][lineNeighborI + 1]), "-->",
                      str(featureVector), "1",
